...
class Blotter extends Component {
    ...
    handleButtonOnClick(){
        ...
        xmlHttp.open("GET", "http://localhost:8080/history?productid=01&period=201907&starttime="+this.state.selectedStartDate.getTime()+"&endtime="+this.state.selectedEndDate.getTime(), true);
