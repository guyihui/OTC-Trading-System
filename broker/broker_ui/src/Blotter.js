...
class Blotter extends Component {
    ...
    handleButtonOnClick(){
        ...
        xmlHttp.open("GET", "http://localhost:30482/history?productid=01&period=201907&starttime="+this.state.selectedStartDate.getTime()+"&endtime="+this.state.selectedEndDate.getTime(), true);
